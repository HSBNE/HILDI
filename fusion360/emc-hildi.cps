...
description = "HILDI Enhanced Machine Controller (EMC)";
vendor = "HSBNE";
vendorUrl = "https://wiki.hsbne.org/tools/metalshop/cnc_mill";
legal = "Copyright (C) 2012-2022 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45702;

longDescription = "HSBNE HILDI Post Processor based on linuxCNC: Enhanced Machine Controller (EMC).";
...
function onSection() {
  ...
  if (insertToolCall) {
    ...
    if (getProperty("preloadTool") && getProperty("useToolCall")) {
  ...
  if (insertToolCall || retracted || (!isFirstSection() && getPreviousSection().isMultiAxis())) {
    ...
    if (!machineConfiguration.isHeadConfiguration()) {
      ...
      writeBlock(gMotionModal.format(0),
        conditional(getProperty("useToolCall"), gFormat.format(43)), zOutput.format(initialPosition.z),
        conditional(getProperty("useToolCall"), hFormat.format(lengthOffset))
      );
    } else {
      writeBlock(
        gAbsIncModal.format(90),
        gMotionModal.format(0),
        conditional(getProperty("useToolCall"), gFormat.format(43)), xOutput.format(initialPosition.x),
        yOutput.format(initialPosition.y),
        zOutput.format(initialPosition.z), conditional(getProperty("useToolCall"), hFormat.format(lengthOffset))
      );
    }
